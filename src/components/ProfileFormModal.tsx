                            ...
                            <aside className="profile-modal__sidebar">
                                ...
                                <div className="profile-modal__info">
                                    <label className="profile-modal__label">
                                        Talent Title
                                        <input type="text" value={form.talentTitle} onChange={e => updateField('talentTitle', e.target.value)} placeholder="e.g. Full Stack Developer" />
                                    </label>
                                    <label className="profile-modal__label">
                                        Phone
                                ...
                                <div className="profile-modal__sections">
                                    ...
                                    <section id="section-skills" className="profile-modal__section">
                                        ...
                                        {form.skills.map((skill, i) => (
                                            <div key={i} className="profile-modal__row">
                                                <input type="text" value={skill} onChange={e => updateSkill(i, e.target.value)} placeholder="e.g. React, Node.js, ..." />
