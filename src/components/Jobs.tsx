...
const jobs = [
    {
        ...
        description: 'Lead development of web applications using React, Node.js, and TypeScript. Mentor junior developers and drive technical decisions.',
    },
    {
        title: 'UI/UX Designer',
        type: 'Full-time',
        location: 'Remote',
        description: 'Design intuitive user interfaces and experiences. Collaborate with developers to bring designs to life with pixel-perfect precision.',
    },
    {
        title: 'DevOps Engineer',
        type: 'Contract',
        location: 'Kigali, Rwanda',
        description: 'Manage cloud infrastructure, CI/CD pipelines, and ensure 99.9% uptime for all production services and deployments.',
    },
];
