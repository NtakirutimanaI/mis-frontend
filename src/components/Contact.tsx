...
const FAQS = [
    { q: 'What services does MIS offer?', a: 'MIS offers a comprehensive range of ICT services including web development, mobile app development, cloud solutions, IT support, cybersecurity, digital transformation consulting, and custom software development.' },
    ...
    { q: 'Do you offer post-launch support?', a: 'Yes, we provide ongoing maintenance, monitoring, and support packages to ensure your solutions remain secure, up-to-date, and performant.' },
    { q: 'What technologies do you use?', a: 'We specialize in modern frameworks including NestJS, React, TypeScript, PostgreSQL, Flutter, React Native, and cloud platforms like AWS and Vercel.' },
];
